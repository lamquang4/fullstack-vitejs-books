...
class BookService_ImageAndDeleteTest {
  ...
  @BeforeEach
  void setup() {
    Category category = Category.builder().id("cat1").status(1).build();

    book = Book.builder().id("book1").title("Test Book").category(category).build();
  }
  ...
  void testDeleteBook_NotFound() {
    ...
    assertThrows(EntityNotFoundException.class, () -> bookService.deleteBook("book1"));
  }
  ...
  void testDeleteBook_InOrder() {
    ...
    assertThrows(IllegalStateException.class, () -> bookService.deleteBook("book1"));
  }
  ...
  void testDeleteBook_DeleteImagesSuccess() {
    ImageBook img =
        ImageBook.builder().id("img1").image("/uploads/books/book1/old.jpg").book(book).build();
  ...
  void testUpdateImagesBook_IOException() throws IOException {
    ...
    ImageBook img = ImageBook.builder().id("img1").image("/uploads/books/book1/test.jpg").build();
    ...
    assertThrows(
        RuntimeException.class, () -> bookService.updateImagesBook(List.of(file), List.of("img1")));
  }
  ...
  void testDeleteImageBook_Success() {
    ImageBook img = ImageBook.builder().id("img1").image("/uploads/books/book1/img.jpg").build();
  ...
  void testDeleteImageBook_NotFound() {
    ...
    assertThrows(EntityNotFoundException.class, () -> bookService.deleteImageBook("img404"));
  }

  @Test
  void testDeleteImageBook_FileNotFound() {
    ImageBook img =
        ImageBook.builder().id("img1").image("/uploads/books/book1/notfound.jpg").build();
