...
class BookService_GetTest {
    ...
    void testGetDiscountedActiveBooks_Success() {
        ...
        Page<BookDTO> result =
                bookService.getDiscountedActiveBooks(1, null, null, 0, 200);
    ...
    void testGetActiveBooksByCategory_Success() {
        ...
        when(bookRepository.findByCategorySlugAndStatusAndPriceRange(eq("fiction"), anyInt(), anyInt(), anyInt(), any(Pageable.class)))
                .thenReturn(page);
        when(orderDetailRepository.findTotalSoldByBook("book1")).thenReturn(10L);

        Page<BookDTO> result =
                bookService.getActiveBooksByCategory("fiction", 1, null, null, 0, 200);
