...
class BookControllerTest {
        ...
        void setup() {
                ...
                ImageBookDTO image = new ImageBookDTO(
                                "img1",
        ...
        void getAllBooks_shouldReturnBooks() throws Exception {
                ...
                Mockito.when(bookService.getAllBooks(1, 12, null, null))
                                .thenReturn(page);
        ...
        void getBySlug_shouldReturnDetail() throws Exception {
                ...
                Mockito.when(bookService.getBookBySlug("kinh-van-hoa"))
                                .thenReturn(bookDetailDTO);

                mockMvc.perform(get("/api/book/slug/{slug}", "kinh-van-hoa"))
                                .andExpect(status().isOk())
        ...
        void getBestsellerBooks() throws Exception {
                ...
                Mockito.when(bookService.getAllBooksByTotalSold())
                                .thenReturn(List.of(bookDTO));

                mockMvc.perform(get("/api/book/bestseller"))
                                .andExpect(status().isOk());
        }
        ...
        void getBookById_shouldReturnDetail() throws Exception {
                ...
                Mockito.when(bookService.getBookById("b1"))
                                .thenReturn(bookDetailDTO);

                mockMvc.perform(get("/api/book/{id}", "b1"))
                                .andExpect(status().isOk())
        ...
        void updateStatus_shouldReturnUpdatedStatus() throws Exception {
                ...
                Mockito.when(bookService.updateBookStatus("b1", 0))
                                .thenReturn(
                                                com.bookstore.backend.entities.Book.builder()
                                                                .id("b1")
                                                                .status(0)
                                                                .build());
        ...
        void deleteBook_shouldReturnNoContent() throws Exception {
                ...
                mockMvc.perform(delete("/api/book/{id}", "b1")
                                .with(csrf()))
        ...
        void deleteImage_shouldReturnNoContent() throws Exception {
                ...
                Mockito.doNothing().when(bookService)
                                .deleteImageBook("img1");

                mockMvc.perform(
                                delete("/api/book/image/{id}", "img1")
                                                .with(csrf()))
                                .andExpect(status().isNoContent());
        }
        ...
        void createBook_withMultipart_shouldReturnOk() throws Exception {
                ...
                Mockito.when(bookService.createBook(
                                Mockito.any(),
                                Mockito.any()))
                                .thenReturn(
                                                com.bookstore.backend.entities.Book.builder()
        ...
        void updateBook_shouldReturnUpdated() throws Exception {
                ...
                Mockito.when(bookService.updateBook(
                                Mockito.eq("b1"),
                                Mockito.any(),
                                Mockito.any()))
                                .thenReturn(
        ...
        void updateImages_shouldReturnNoContent() throws Exception {
                ...
                Mockito.doNothing()
                                .when(bookService)
                                .updateImagesBook(Mockito.any(), Mockito.any());
