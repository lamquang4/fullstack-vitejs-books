...
public class PaymentIntegrationTest {
  ...
  void getAllPayments_shouldReturnAll() throws Exception {
    ...
    mockMvc
        .perform(get("/api/payment").param("page", "1").param("limit", "10"))
  ...
  void getAllPayments_filterByOrderCode() throws Exception {
    ...
    mockMvc
        .perform(get("/api/payment").param("page", "1").param("limit", "10").param("q", "PAY1"))
        .andExpect(status().isOk())
  ...
  void getAllPayments_filterByStatus() throws Exception {
    ...
    mockMvc
        .perform(get("/api/payment").param("page", "1").param("limit", "10").param("status", "1"))
        .andExpect(status().isOk())
