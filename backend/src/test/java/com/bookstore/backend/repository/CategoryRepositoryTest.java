...
class CategoryRepositoryTest {
    ...
    void findByNameContainingIgnoreCase_shouldReturnPagedResults() {
        Page<Category> page = categoryRepository.findByNameContainingIgnoreCase(
                "fi",
                PageRequest.of(0, 10)
        );
    ...
    void findByStatus_shouldReturnCorrectCategories() {
        Page<Category> page = categoryRepository.findByStatus(
                1,
                PageRequest.of(0, 10)
        );
    ...
    void findByNameContainingIgnoreCaseAndStatus_shouldReturnFilteredResults() {
        Page<Category> page = categoryRepository.findByNameContainingIgnoreCaseAndStatus(
                "his",
                0,
                PageRequest.of(0, 10)
        );
