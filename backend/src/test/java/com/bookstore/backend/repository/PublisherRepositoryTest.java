...
class PublisherRepositoryTest {
    ...
    @BeforeEach
    void setup() {
        publisher1 = publisherRepository.save(
                Publisher.builder()
                        .name("NXB Trẻ")
                        .slug("nxb-tre")
                        .build()
        ...
        publisher2 = publisherRepository.save(
                Publisher.builder()
                        .name("Kim Đồng")
                        .slug("kim-dong")
                        .build()
    ...
    void findByNameContainingIgnoreCase_shouldReturnMatchingPublishers() {
        var result = publisherRepository.findByNameContainingIgnoreCase(
                "nxb", PageRequest.of(0, 10)
        );
