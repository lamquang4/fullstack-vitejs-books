...
class BookRepositoryTest {
    ...
    void setup() {
        ...
        publisher = publisherRepository.save(
                Publisher.builder().name("NXB Kim Dong").slug("kim-dong").build()
        );
    ...
    void findByDiscountGreaterThanAndStatus_shouldReturnBook() {
        Page<Book> page = bookRepository.findByDiscountGreaterThanAndStatus(0, 1, PageRequest.of(0, 10));
    ...
    void searchByTitleAuthorPublisherCategory_shouldReturnMatchingBooks() {
        Page<Book> page = bookRepository.searchByTitleAuthorPublisherCategory(
                "kim", 1, PageRequest.of(0, 10)
        );
    ...
    void findByStatusAndPriceRangeOrderByTotalSold_shouldReturnSortedBooks() {
        ...
        Page<Book> page = bookRepository.findByStatusAndPriceRangeOrderByTotalSold(
