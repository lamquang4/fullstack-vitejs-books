...
public interface OrderRepository extends JpaRepository<Order, String> {
   ...
   Page<Order> findByStatusAndCreatedAtBetween(Integer status, LocalDateTime start, LocalDateTime end,
         Pageable pageable);

   Page<Order> findByOrderCodeContainingIgnoreCaseAndCreatedAtBetween(String orderCode, LocalDateTime start,
         LocalDateTime end, Pageable pageable);

   Page<Order> findByOrderCodeContainingIgnoreCaseAndStatusAndCreatedAtBetween(String orderCode, Integer status,
